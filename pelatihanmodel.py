# -*- coding: utf-8 -*-
"""PelatihanModel.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1LnVYL-oVo8eXYdxuttF5LNnuNzVoT6Ft
...
app_reviews_df = app_reviews_df.copy()
# Menghitung jumlah baris dan kolom dalam DataFrame app_reviews_df setelah menghapus duplikat
jumlah_ulasan_setelah_hapus_duplikat, jumlah_kolom_setelah_hapus_duplikat = app_reviews_df.shape
...
# Mengambil jumlah data polaritas sentimen dari DataFrame 'app_reviews_df' dan menyimpannya dalam list 'sizes'.
sizes = [count for count in app_reviews_df['polarity'].value_counts()]

# Mengambil label atau kategori sentimen dari DataFrame 'app_reviews_df' dan menyimpannya dalam list 'labels'.
...
neutral_tweets = app_reviews_df[app_reviews_df['polarity'] == 'neutral']
...
# Iterasi melalui setiap tweet dalam kolom 'text_stopword' dari DataFrame 'app_reviews_df'.
...
"""Dalam kasus Sentiment Analysis ini, Logistic Regression mencapai akurasi tertinggi sebesar 93,16%. Oleh karena itu, algoritma Logistic Regression dipilih sebagai model utama yang akan digunakan untuk memprediksi sentimen pada kalimat-kalimat baru."""
